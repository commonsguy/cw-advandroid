...
public class BshServiceDemo extends Activity {
	...
	private EvalReceiver onResult=new EvalReceiver(handler);
	...
	public void evalResultReceiver(View v) {
		Intent i=new Intent("com.commonsware.android.advservice.IScript");
		
		i.putExtra(SCRIPT, script.getText().toString());
		i.putExtra(RECEIVER, onResult);
	...
	private class EvalReceiver extends ResultReceiver {
		EvalReceiver(Handler h) {
			super(h);
		}
		
		@Override
		public void onReceiveResult(int resultCode, Bundle resultData) {
			String result=resultData.getString(PAYLOAD);
